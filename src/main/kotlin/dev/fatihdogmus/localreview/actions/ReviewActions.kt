package dev.fatihdogmus.localreview.actions
...
import dev.fatihdogmus.localreview.diff.REVIEW_DIFF_EDITOR_KEY
import dev.fatihdogmus.localreview.ui.showInlineCommentForm
import dev.fatihdogmus.localreview.vcs.ChangedFileStatus
import dev.fatihdogmus.localreview.ui.AddCommentDialog
    ...
    override fun actionPerformed(event: AnActionEvent) {
        ...
        if (editor != null && requestData != null) {
            ...
            if (review != null && file != null) {
                ...
                if (changedFile != null) {
                    val dialog = AddCommentDialog(project, changedFile)
